...
<div class="input_fields_wrap">
	...
	for($m=1;$m<=$numbers;$m++)
	{
		?>
	<div class="row">
    <div class="form-group"><label for="name">Question No.</label>
    <input type="text" class="form-control" id="name" name="name[]" placeholder="Enter Number" required>
	</div>
	<div class="form-group"><label for="age">Subject Id</label>
    <input type="number" class="form-control" id="age" name="age[]" placeholder="Enter Option 1" required></div>
	...
	<div class="form-group"><label for="answer">Answer</label>
...
else
{
	...
	$sql="INSERT INTO questions(sub_id, subject, question, optionA, optionB, optionC, optionD, answer) values('$sub_id','$subject',$name',$age,'$question','$optionA','$optionB','$optionC','$optionD','$answer')";
